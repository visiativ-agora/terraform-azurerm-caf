locals {
  remote_objects = {
    ...
    azuread_service_principal_names                = try(local.combined_objects_azuread_service_principal_names, null)
    ...
    backup_vault_instances                         = try(local.combined_objects_backup_vault_instances, null)
    ...
    azure_bots                                     = try(local.combined_objects_azure_bots, null)
    ...
    managed_redis                                  = try(local.combined_objects_managed_redis, null)
    ...
    mysql_flexible_servers                         = try(local.combined_objects_mysql_flexible_servers, null)
    ...
    network_manager_admin_rules                    = try(local.combined_objects_network_manager_admin_rules, null)
    network_manager_admin_rule_collections         = try(local.combined_objects_network_manager_admin_rule_collections, null)
    network_manager_connectivity_configurations    = try(local.combined_objects_network_manager_connectivity_configurations, null)
    network_manager_deployments                    = try(local.combined_objects_network_manager_deployments, null)
    network_manager_management_group_connections   = try(local.combined_objects_network_manager_management_group_connections, null)
    network_manager_network_groups                 = try(local.combined_objects_network_manager_network_groups, null)
    network_manager_scope_connections              = try(local.combined_objects_network_manager_scope_connections, null)
    network_manager_security_admin_configurations  = try(local.combined_objects_network_manager_security_admin_configurations, null)
    network_manager_static_members                 = try(local.combined_objects_network_manager_static_members, null)
    network_manager_subscription_connections       = try(local.combined_objects_network_manager_subscription_connections, null)
    ...
    subnet_service_endpoint_storage_policies       = try(local.combined_objects_subnet_service_endpoint_storage_policies, null)
