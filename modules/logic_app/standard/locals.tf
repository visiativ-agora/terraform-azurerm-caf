locals {
  ...
  service_plan    = var.service_plans[try(var.settings.service_plan.lz_key, var.settings.lz_key, var.client_config.landingzone_key)][try(var.settings.service_plan.key, var.settings.service_plan_key)]
