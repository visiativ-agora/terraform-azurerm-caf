...
locals {
  ...
  logs_storage_account = can(var.settings.logs) ? var.storage_accounts[try(var.settings.logs.lz_key, var.client_config.landingzone_key)][try(var.settings.logs.storage_account_key, null)] : null
  ...
  http_logs_storage_account = can(var.settings.logs.http_logs) ? var.storage_accounts[try(var.settings.logs.http_logs.lz_key, var.client_config.landingzone_key)][try(var.settings.logs.http_logs.storage_account_key, null)] : null
