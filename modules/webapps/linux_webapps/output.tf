output "id" {
  value       = azurerm_linux_web_app.linux_web_apps.id
...
output "outbound_ip_addresses" {
  value       = azurerm_linux_web_app.linux_web_apps.outbound_ip_addresses
  description = "A comma separated list of outbound IP addresses"
}
output "possible_outbound_ip_addresses" {
  value       = azurerm_linux_web_app.linux_web_apps.possible_outbound_ip_addresses
  description = "A comma separated list of outbound IP addresses. not all of which are necessarily in use"
}
output "identity" {
  value       = try(azurerm_linux_web_app.linux_web_apps.identity.0.principal_id, null)
