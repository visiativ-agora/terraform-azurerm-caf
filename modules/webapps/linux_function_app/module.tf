...
resource "azurerm_linux_function_app" "linux_function_app" {
  ...
  site_config {
    ...
    application_insights_connection_string = try(var.application_insight.connection_string, null)
    application_insights_key               = try(var.application_insight.instrumentation_key, null)
