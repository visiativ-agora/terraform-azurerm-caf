# https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/windows_function_app_slot

resource "azurerm_windows_function_app_slot" "windows_function_app_slot" {
  name            = azurecaf_name.windows_function_app_slot.result
  ...
  dynamic "auth_settings" {
    ...
    content {
      ...
      dynamic "google" {
        for_each = try(var.settings.auth_settings.google, {}) != {} ? [1] : []
        content {
      ...
      dynamic "twitter" {
        for_each = try(var.settings.auth_settings.twitter, {}) != {} ? [1] : []
        content {
      ...
      dynamic "microsoft" {
        for_each = try(var.settings.auth_settings.microsoft, {}) != {} ? [1] : []
        content {
    ...
    content {
      ...
      dynamic "active_directory_v2" {
        ...
        content {
          ...
          www_authentication_disabled          = try(var.settings.auth_settings_v2.active_directory_v2.www_authentication_disabled, null)
      ...
      dynamic "microsoft_v2" {
        ...
        content {
          ...
          allowed_audiences          = try(var.settings.auth_settings_v2.microsoft_v2.allowed_audiences, null)
          login_scopes               = try(var.settings.auth_settings_v2.microsoft_v2.login_scopes, null)
        }
      }
  ...
  key_vault_reference_identity_id = try(
    ...
    var.remote_objects.managed_identities[try(var.settings.key_vault_reference_identity.lz_key, var.client_config.landingzone_key)][var.settings.key_vault_reference_identity.key].id,
    null
  )
  ...
  dynamic "storage_account" {
    ...
    content {
      access_key = try(
        ...
        var.remote_objects.storage_accounts[try(storage_account.value.lz_key, var.client_config.landingzone_key)][storage_account.value.key].primary_access_key
      )
      account_name = try(
        storage_account.value.account_name,
        var.remote_objects.storage_accounts[try(storage_account.value.lz_key, var.client_config.landingzone_key)][storage_account.value.key].name
      )
  ...
  storage_account_access_key = try(
    ...
    var.remote_objects.storage_accounts[try(var.settings.storage_account_key.lz_key, var.client_config.landingzone_key)][var.settings.storage_account_key.key].primary_access_key
  )

  storage_account_name = try(
    var.settings.storage_account_name,
    var.remote_objects.storage_accounts[try(var.settings.storage_account_key.lz_key, var.client_config.landingzone_key)][var.settings.storage_account_key.key].name
  )
