...
output "tenant_id" {
  ...
  value       = try(azurerm_windows_function_app.windows_function_app.identity[0].tenant_id, null)
}

output "site_credential_name" {
  description = "The Site Credentials Username used for publishing."
  value       = azurerm_windows_function_app.windows_function_app.site_credential[0].name
}
