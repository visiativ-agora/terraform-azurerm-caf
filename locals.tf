...
locals {
  ...
  networking = {
    ...
    cdn_frontdoor_profile                                   = try(var.networking.cdn_frontdoor_profile, {})
    cdn_frontdoor_route                                     = try(var.networking.cdn_frontdoor_route, {})
    cdn_frontdoor_rule                                      = try(var.networking.cdn_frontdoor_rule, {})
    cdn_frontdoor_rule_set                                  = try(var.networking.cdn_frontdoor_rule_set, {})
    cdn_frontdoor_security_policy                           = try(var.networking.cdn_frontdoor_security_policy, {})
